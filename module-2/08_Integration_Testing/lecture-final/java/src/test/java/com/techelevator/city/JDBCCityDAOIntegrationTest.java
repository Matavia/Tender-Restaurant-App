...
public class JDBCCityDAOIntegrationTest {
	...
	@Before
	public void setup() {
		// INSERT a fake country into the country table
		...
		// insert the country
		jdbcTemplate.update(sqlInsertCountry, TEST_COUNTRY); // <- notice we pass in the country code constant as a
																// parameter)
	...
	private void assertCitiesAreEqual(City expected, City actual) {
		...
		// if I override the equals method on city I could just do
