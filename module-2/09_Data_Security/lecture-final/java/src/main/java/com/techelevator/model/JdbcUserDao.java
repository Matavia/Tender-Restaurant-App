...
public class JdbcUserDao implements UserDao {
    ...
    public String getSortQuery(String selectedSort) {
    ...
    public List<User> getAllUsersSorted(String sortValue) {
    	
    	//String sqlSelectAllUsers = "SELECT id, username FROM users ORDER BY ?"; // this does not work
