...
public class Exercises {
	...
	// within the loop create an if statement that will skip the words with 4
	// characters
	...
	public Integer findLargest(List<Integer> integerList) {
		/*
		 * Here is the code I started with before finding out
		 * Collections.max(integerList) way, Could you tell me where I went wrong with
		 * this one ----------------------------------------------------- int
		 * biggerInteger = 0;
		 * 
		 * for(int n = 0; n < integerList.size(); n++) { int a = integerList.get(n); int
		 * b = integerList.get(n++);
		 * 
		 * if(a > b) {
		 * 
	 ...
	 * 
	 * foundIntTwice( [5, 7, 9, 5, 11], 5 ) -> true foundIntTwice( [6, 8, 10, 11,
	 * 13], 8 -> false foundIntTwice( [9, 23, 44, 2, 88, 44], 44) -> true
	 */
