...
// Week 04 - Loops and Arrays My Exercise Solutions
...
public class Exercises {
	...
	public boolean firstLast6(int[] nums) {
		...
		boolean isFirstEqualToSix = nums[0] == 6;
		boolean isLastEqualToSix = nums[nums.length - 1] == 6;

		return isFirstEqualToSix || isLastEqualToSix;
	...
	public boolean sameFirstLast(int[] nums) {
		...
		boolean lengthOneOrMore = nums.length >= 1;
		boolean firstAndLastEqual = nums[0] == nums[nums.length - 1];

		return lengthOneOrMore && firstAndLastEqual;
	}
	...
	// Return an array 0 - 2 containing the first 3 digits of pi
	public int[] makePi() {
	...
	public boolean commonEnd(int[] a, int[] b) {
		...
		boolean sameLastElement = a[a.length - 1] == b[b.length - 1];
	...
	// if array.length < 2, sum up elements that exist
	...
	public boolean lucky13(int[] nums) {
		...
		boolean thirteenOrNaw = yes == 0;
		return thirteenOrNaw;
	...
	// true if sum of all twos is exactly 8
