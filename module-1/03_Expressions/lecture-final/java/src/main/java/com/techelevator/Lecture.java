...
// access return type   method name   argument list   start a block
	...
	// access return type name argument list
	...
	public boolean returnTrueGreaterThanFiveSimple(int number) {
		return number > 5;
	}
