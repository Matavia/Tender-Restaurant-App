...
public class LectureTest {
	...
	public void length_returns_the_number_of_characters_in_a_String() {
		...
		int expectedLength = 4; // arrange
		String theString = "Java"; // Arrange
		
		
		// ACT
		// Run the code that we are intending to test
		int length = theString.length(); // Act
		
		
		// Assert phase
		// write one or more assertions to validate 
		// that the ACT returned the right value, and that the classes 
		// in question is in the right state
